...
Using LLMs trained on a vast range of human writing, _HeadlineWise_ analyzes the language of headlines to try to illustrate exactly how language choice can affect the way we respond to information. If we can learn to recognize language that is subjective and inflammatory or meant to provoke an emotional response, then perhaps we can be more conscious of how our attention is being engaged and used.
...
Each headline is then sent to an AI model for analysis. Currently _HeadlineWise_ uses models by Anthropic and OpenAI, but may expand to others in the future.
...
- Journalists, media critics, psychologists, and other domain experts to critique the concept, contribute to future features, and participate in AI analysis review
- Anyone else who’d like to buy me a coffee to help cover project costs (particularly database storage and API costs) so that this project can continue longer term
